...
import { TutorialLayout, type TutorialLayoutData } from '../TutorialLayoutData';
...
export interface MeetupRouter {
  ['/tutorials']: (data: Meetup, locals: TutorialLayoutData) => TutorialLayout;
}

export const MeetupRouter: MeetupRouter = {
  ['/tutorials'](data: Meetup, locals: TutorialLayoutData): TutorialLayout {
    return new TutorialLayout(new MeetupPage(data), locals);
  },
};
